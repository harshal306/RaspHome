...
public class Main2Activity extends AppCompatActivity implements OnCheckedChangeListener {
TextView txvResult;
Switch swi;
ImageView img;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swi.setOnCheckedChangeListener((CompoundButton.OnCheckedChangeListener) Main2Activity.this);
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
        ...
        {
            img.setImageResource(R.drawable.transoff);
            TransitionDrawable td=(TransitionDrawable)img.getDrawable();
            td.startTransition(3000);
